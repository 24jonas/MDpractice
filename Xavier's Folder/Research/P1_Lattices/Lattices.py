# This was downloaded from discord. The initial parameters were for silver using the 'manual approach'.
...
# a = 4.085     Lattice constant for silver
a = 3.57        # Lattice constant for diamond           
